...
describe("DashboardPage", () => {
  ...
  it("renders dashboard stat cards", async () => {
    ...
    expect(
      screen.getByText((content) => content.trim().startsWith(String.fromCharCode(0x2191)))
    ).toBeInTheDocument();
  ...
  it("renders downward rank movement", async () => {
    ...
    expect(
      await screen.findByText((content) => content.trim().startsWith(String.fromCharCode(0x2193)))
    ).toBeInTheDocument();
  });
  ...
  it("renders unchanged rank movement", async () => {
    ...
    expect(
      await screen.findByText((content) => content.trim() === String.fromCharCode(0x2192))
    ).toBeInTheDocument();
  });
