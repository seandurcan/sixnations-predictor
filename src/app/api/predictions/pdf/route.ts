...
export async function GET() {
  try {
    ...
    if (!predictions.length) {
      return Response.json(
        { error: "You have no submitted predictions to download yet." },
    ...
    if (!unauthenticated) {
      console.error("Prediction PDF generation failed", error);
    }
    ...
    return Response.json(
      {
        error: unauthenticated
          ...
          : "Unable to generate your predictions PDF. Please try again.",
      },
      {
