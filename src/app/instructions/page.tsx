          ...
          <Card title="Making Your Predictions">
            <div className="space-y-4 text-[var(--brand-muted)]">
              ...
              <ol className="list-decimal space-y-3 pl-5">
                <li>
                  <strong className="text-[var(--brand-navy)]">Navigate to Predictions:</strong> Go to the Predictions page from the main navigation menu before the tournament kicks off.
                </li>
                <li>
